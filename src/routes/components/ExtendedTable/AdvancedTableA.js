    ...
    return [
      ...
      },
      {
        ...
        ...buildCustomSelectFilter({
          ...
          options: [
            { value: ProductQuality.Good, label: "İyi" },
            { value: ProductQuality.Bad, label: "Kötü" },
            { value: ProductQuality.Unknown, label: "Bilinmiyor" },
          ],
          getFilter: (filter) => {
      ...
      },
      {
        ...
        ...buildCustomSelectFilter({
          placeholder: "Memnuniyet Oranı Seçiniz",
        ...
        {(props) => (
          <React.Fragment>
            <div className='d-flex justify-content-end align-items-center mb-2'>
              <h6 className='my-0'>Gelişmiş Tablo A</h6>
              <div className='d-flex ml-auto'>
                <CustomSearch className='mr-2' {...props.searchProps} />
                <ButtonGroup>
                  <CustomExportCSV {...props.csvProps}>Dışarı Aktar</CustomExportCSV>
                  <Button
                    size='sm'
                    outline
