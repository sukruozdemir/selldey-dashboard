  ...
  render() {
    ...
    return (
      <Pagination className={containerClassName}>
        <PaginationItem className={previousClasses}>
          <PaginationLink
            previous
          ...
          >
            <i className='fa fa-fw fa-angle-left'></i> {previousLabel}
          </PaginationLink>
        </PaginationItem>

        {this.pagination()}

        <PaginationItem className={nextClasses}>
          <PaginationLink
            next
          ...
          >
            <i className='fa fa-fw fa-angle-right'></i> {nextLabel}
          </PaginationLink>
        </PaginationItem>
      </Pagination>
    );
